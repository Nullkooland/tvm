...
TVM_DLL Map<String, String> GetLibInfo() {
  Map<String, String> result = {
      ...
      {"USE_TIM_VX_CODEGEN", TVM_INFO_USE_TIM_VX_CODEGEN},
      {"USE_TIM_VX_RUNTIME", TVM_INFO_USE_TIM_VX_RUNTIME},
      {"USE_OPENVX_RUNTIME", TVM_INFO_USE_OPENVX_RUNTIME},
      {"USE_VIPLITE_RUNTIME", TVM_INFO_USE_VIPLITE_RUNTIME},
  };
  return result;
}
